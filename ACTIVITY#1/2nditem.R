...
URL <- "https://www.amazon.com/s?k=adidas+skate+shoes+for+men&crid=3Q7TMQAJRWAPF&sprefix=addidas+skater+shoes+fo%2Caps%2C3558&ref=nb_sb_ss_ts-doa-p_1_23"
...
divElements <- html_nodes(sessionPage, 'sg-col-4-of-24 sg-col-4-of-12 s-result-item s-asin sg-col-4-of-16 sg-col s-widget-spacing-small sg-col-4-of-20')
...
write.csv(DF, "2ndproduct.csv")

DF$Category <- "SkaterShoes"

DF <- DF[, c("Category", names(DF)[-which(names(DF) == "Category")])]

write.csv(DF, "2ndproduct2.csv", row.names = FALSE)
