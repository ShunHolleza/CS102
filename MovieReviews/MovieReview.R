...
url <- 'https://www.imdb.com/title/tt0848228/reviews/_ajax?ref_=undefined&paginationKey=%s'
...
for (page in 1:pagesToscrape) {
  scrapedData <- scrapePage(url, PaginationKey)
...
write.csv(DF, file = "1stmovie.csv", row.names = FALSE)
print(DF)
